...
final class MagasinController
{
    ...
    public function handle(): void
    {
        ...
        $this->redirect('../View/back_office/material_able-main/magasins.php');
    }
    ...
    private function save(): void
    {
        ...
        try {
            if ($payload['id_mag'] > 0) {
                ...
                $this->redirect('../View/back_office/material_able-main/magasins.php?status=updated');
            }

            $this->magasin->create($payload, is_array($image) ? $image : []);
            $this->redirect('../View/back_office/material_able-main/magasins.php?status=success');
        } catch (Throwable $exception) {
            $this->redirect('../View/back_office/material_able-main/magasins.php?status=dberror');
        }
    }
    ...
    private function delete(): void
    {
        try {
            ...
            $this->redirect('../View/back_office/material_able-main/magasins.php?status=deleted');
        } catch (Throwable $exception) {
            $this->redirect('../View/back_office/material_able-main/magasins.php?status=deleteerror');
        }
    }
