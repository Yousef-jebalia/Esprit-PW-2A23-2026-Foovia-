                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Current Image</label><br>
                                ...
                                <img src="<?php echo htmlspecialchars(resolve_backoffice_asset_path($recipeData['img_rec'])); ?>" alt="Current recipe image" style="width:100px;height:100px;object-fit:cover;border-radius:6px;">
                            <?php else: ?>
                                <span>No image</span>
                            <?php endif; ?>
                        </div>
