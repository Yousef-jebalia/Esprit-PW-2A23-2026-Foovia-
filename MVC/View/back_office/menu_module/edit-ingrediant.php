                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($ingrediantData['img_ing'])): ?>
                                <img src="<?php echo htmlspecialchars(resolve_backoffice_asset_path($ingrediantData['img_ing'])); ?>" alt="Current ingrediant image" style="width:100px;height:100px;object-fit:cover;border-radius:6px;">
                            <?php else: ?>
                                <span>No image</span>
                            <?php endif; ?>
                        </div>
